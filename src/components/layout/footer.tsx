  ...
  return (
    <footer class="bg-secondary text-secondary-foreground">
      <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div class="lg:col-span-2">
            <Link href="/" class="flex items-center space-x-2 mb-4">
              <span class="text-2xl font-bold">Solamp</span>
            </Link>
            <p class="text-sm text-secondary-foreground/80 mb-4">
              Empowering sustainable living through solar energy and eco-friendly solutions. 
              From the USA to Ghana and beyond.
            </p>
        ...
        {/* Bottom Bar */}
        <div class="mt-12 pt-8 border-t border-secondary-foreground/20">
          <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p class="text-sm text-secondary-foreground/80">
              © 2025 Solamp. All rights reserved.
            </p>
